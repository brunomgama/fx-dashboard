			...
			<div className="flex-1 p-6">
				<div className="mx-auto space-y-6">
					<div className="flex items-start justify-between">
						...
						<Button onClick={() => {checkAllAuthStatus(AWS_PROFILES.map((p) => p.name)); setOpenAuthenticator(false);}}
							disabled={isChecking} variant="outline" size="sm">
					...
					{ssoResult && openAuthenticator && (
						<VerificationBox currentProfile={ssoResult.currentProfile} verificationCode={ssoResult.verificationCode}
							ssoUrl={ssoResult.ssoUrl} onCopy={(text) => navigator.clipboard.writeText(text)} />
					)}
