...
export function FlowTechnicalDetails({ flow }: { flow: Flow }) {
	...
	return (
		<div className='space-y-3'>
			<h3 className='font-montserrat text-sm font-black uppercase tracking-wide text-muted-foreground'>Technical Details</h3>
			<div className='space-y-2 rounded-lg bg-muted/30 p-3'>
				<div>
					<div className='flex items-center justify-between'>
						<Label className='font-montserrat text-xs font-semibold text-muted-foreground'>Flow ID</Label>
				...
				<div>
					<Label className='font-montserrat text-xs font-semibold text-muted-foreground'>ARN</Label>
