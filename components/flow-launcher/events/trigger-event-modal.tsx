...
import { Event } from '@/types/flow-launcher';
...
export function TriggerEventModal({ event, open, onClose }: TriggerEventModalProps) {
	...
	const getConsoleUrl = () => {
		...
		return `https://${environmentConfig.region}.console.aws.amazon.com/states/home?region=${environmentConfig.region}#/executions/details/${executionArn}`;
	};
